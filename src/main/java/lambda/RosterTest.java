    ...
    public static void main(String... args) {
        ...
        processPersons(
            ...
            p -> p.getGender() == Person.Sex.MALE
                && p.getAge() >= 18
                && p.getAge() <= 25,
            p -> {System.out.println(p.getName()); System.out.println(p.getAge()); p.printPerson();}
        );
        ...
        System.out.println("a diff twist with predicate function as a variable");
        processElements(
                roster,
                pred,
                p -> p.getEmailAddress(),
